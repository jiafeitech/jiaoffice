...
source=("onlyoffice-desktopeditors-${CARCH}-${pkgver}.deb"::"https://github.com/ONLYOFFICE/DesktopEditors/releases/download/v${pkgver}/onlyoffice-desktopeditors_amd64.deb" "desktop.patch" "word.png")
noextract=("onlyoffice-desktopeditors-${CARCH}-${pkgver}.deb")
sha256sums=('16519e98718803b29e54e81b09a231406ddb0342ab68320ebb9508a312e0b5de' 'SKIP' 'SKIP')
